...
- (void)setScore:(NSInteger)score {
    for (int i = 0; i < 5; i ++) {
        UIImageView *grayImage = [[UIImageView alloc] initWithFrame:CGRectMake((starWidth + 8) * i, 0, starWidth, self.frame.size.height)];
    ...
    for (NSInteger i = 0; i < score; i ++) {
        UIImageView *redImage = [[UIImageView alloc] initWithFrame:CGRectMake((starWidth + 8) * i, 0, starWidth, self.frame.size.height)];
