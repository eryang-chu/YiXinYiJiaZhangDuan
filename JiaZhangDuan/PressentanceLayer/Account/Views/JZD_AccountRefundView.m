...
@interface JZD_AccountRefundView () <UITableViewDelegate, UITableViewDataSource>
...
@implementation JZD_AccountRefundView
...
- (void)awakeFromNib {
    ...
    self.topView.titleLabel.text = @"退款";
    @weakify(self);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.cellType = JZD_ObligationTableViewCellTyperefund;
    [cell.obligationButton setTitle:@"已退款" forState:UIControlStateNormal];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.refundButtonClick) {
        self.refundButtonClick(indexPath);
    }
}
/*
