//
//  JZD_AccountBabyBasicInfoView.m
//  JiaZhangDuan
//
...
@interface JZD_AccountBabyBasicInfoView () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) JZD_ForgetPwdTopView *topView;
@end
@implementation JZD_AccountBabyBasicInfoView
...
- (void)awakeFromNib {
    ...
    self.topView.titleLabel.text = @"基本信息";
    @weakify(self);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!indexPath.row) {
        cell.cellType = JZD_AccountBabyInfoTableViewCellTypeImage;
    }else if (indexPath.row == 3) {
        cell.cellType = JZD_AccountBabyInfoTableViewCellTypeNextNoLabel;
    } else {
        cell.cellType = JZD_AccountBabyInfoTableViewCellTypeNextWithLabel;
    }
