//
//  JZD_AccountSetViewController.m
//  JiaZhangDuan
//
...
#import "JZD_AccountSetViewController.h"

@interface JZD_AccountSetViewController ()
...
@implementation JZD_AccountSetViewController
...
- (void)viewDidLoad {
    ...
    @weakify(self);
    self.accountSetView.backButtonClick = ^{
        @strongify(self);
